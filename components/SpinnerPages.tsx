export const SpinnerPages = () => {
  return (
    <div className='fixed z-50 inset-0 backdrop-blur-lg h-full w-full flex items-center justify-center'>
      <div className='overflow-hidden mt-6 animate-spin-slow text-gray-300/30'>
        <div role='status'>
          <svg
            width='100'
            height='100'
